...
export function onEmailInput(e) {
	getCoord(e);
...
export function onEmailFocus(e) {
	e.target.parentElement.classList.add("focusWithText");
	getCoord();
}

export function onEmailBlur(e) {
	if(e.target.value == "") {
...
export function onPasswordFocus(e) {
	coverEyes();
}

export function onPasswordBlur(e) {
	uncoverEyes();
}
